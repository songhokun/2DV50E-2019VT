...
In the previous chapter, several privacy enhancing studies were anaylsed in terms of contribution to privacy enhancements on end-users.
...
\subsubsection{Integrity of the DNS records}
Radical protocol design proposals may harm the integrity of the DNS records, as its proof-censorship or leagl attack proof designs may enable everyone can claim the legitimicy or ownership of the specific domain.
Interventing the malevoneous records are more challenging than the hierarchial structure of the current DNS system in the decentralised design, and this could lead to concerns of enabling phishing attacks.
Enhancing confidentiality aspects of DNS security is important but it should not compromise integrity aspect.

\subsubsection{Availability}
Studies in the earlier time of the Internet suggest that DNS resolutions are significant cause of having log Web waits \cite{cohen2003proactive, jung2002dns}. `User-perceived latency '
