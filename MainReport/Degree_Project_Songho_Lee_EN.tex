...
%----------------------------------------------------------------------------------------
\newpage
\textbf {\large{Revision history for the seminar}}\\
...
We fetched a URL list of frequently visited websites as described in Appendix \ref{processweblist} and generated web traffic as described in Appendix \ref{visitwebsites}.
...
Figure \ref{mode2packets} shows a result of packet captures filtered with DNS (port 53) of a Firefox (66.0.2) simulation which network.trr.mode is set as 2 and executed top 10 websites of 'de' domain.

\begin{figure}[h!]
    \begin{center}
    \includegraphics*[width=0.9\columnwidth]{img/firefox-mode2/wireshark}
    \end{center}
...
\inputpython{../Selenium/process_web_list.py}{1}{72}
