...
\begin{table}[h!]
    \begin{tabular} {|p{1.2cm}|p{12.8cm}|} \hline
        \textbf{O1} & Analyse different end-users' privacy infringement in scenarios without DNS Privacy\\ \hline
        ...
        \textbf{O4} & Analyse alternative approaches to mitigating the current limitations.\\ \hline
    \end{tabular}
    \caption{Objectives}
    \label{objectives}
\end{table}
...
\section{Limitations of DNS Privacy methods}
