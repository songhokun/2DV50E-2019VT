...
\begin{table}[h!]
    \begin{tabular} {|p{1.2cm}|p{12.8cm}|} \hline
        ...
        \textbf{RQ3} & Which interests would DNS Privacy bring to different parties? \\ \hline
    \end{tabular}
...
\begin{table}[h!]
    \begin{tabular} {|p{1.2cm}|p{12.8cm}|} \hline
        ...
        \textbf{O2} & Analyse different end-user interests concerning DNS Privacy\\ \hline
