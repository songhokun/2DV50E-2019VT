...
The report presented the limitations of the current DNS privacy technologies and explored the alternative approaches to overcome the limitations from the current techniques, which was to use Tor and frequently changing a trusted recursive resolver.
