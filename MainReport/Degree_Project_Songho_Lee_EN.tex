...
In the previous chapter, several privacy enhancing studies were analysed in terms of contribution to privacy enhancements on end-users.
...
Radical protocol design proposals may harm the integrity of the DNS records, as its proof-censorship or legal attack proof designs may enable everyone can claim the legitimacy or ownership of the specific domain.
...
Studies in the earlier time of the Internet suggest that DNS resolutions are a significant cause of having log Web waits \cite{cohen2003proactive, jung2002dns}. `User-perceived latency '
