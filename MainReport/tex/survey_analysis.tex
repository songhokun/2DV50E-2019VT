...
However, security concerns arise in terms of availability for \textit{Oblivious DNS}, as ODNS operations require ODNS-stubs and imposing such design creates a new `central point of failure \cite{minutes-102-dprive}'.
